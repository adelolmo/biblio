@echo off
REM **********************************************************************
REM   Copyright (c) 2013-2014 Nicando Software GmbH. All rights reserved.
REM **********************************************************************
...
"%JAVA_HOME%"\bin\java %JAVA_OPTS% -Dlog4j.configuration=file:%LOGFILE% -Dfile.encoding=ISO-8859-1 -classpath "%LOCALCLASSPATH%" "com.nicando.at.actlauncher.AcceptanceLauncher"